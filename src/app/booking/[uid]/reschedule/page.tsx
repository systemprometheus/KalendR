  ...
  return (
    <div className="min-h-screen bg-gray-50 flex items-center justify-center p-4">
      <div className="bg-white rounded-2xl shadow-sm border p-8 max-w-md w-full text-center">
        <RefreshCw className="w-12 h-12 text-[#0069ff] mx-auto mb-4" />
        ...
        <a
          ...
          className="inline-block px-6 py-2 bg-[#0069ff] text-white rounded-lg text-sm font-medium hover:bg-[#0052cc]"
        >
          Cancel & Rebook
        </a>
      </div>
