    ...
    <div className="min-h-screen bg-white">
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="flex items-center justify-between h-16">
            ...
            <div className="flex items-center gap-3">
              ...
              <Link href="/signup" className="text-sm font-medium text-white bg-[#0069ff] hover:bg-[#0052cc] px-4 py-2 rounded-lg transition-colors">
                Get Started Free
              </Link>
            </div>
          </div>
      ...
      <section className="pt-20 pb-16 px-4">
        <div className="max-w-4xl mx-auto text-center">
          <div className="inline-flex items-center gap-2 bg-blue-50 text-[#0069ff] text-sm font-medium px-4 py-1.5 rounded-full mb-6">
            <Zap className="w-4 h-4" /> Built for inbound sales teams
          </div>
          <h1 className="text-5xl md:text-6xl font-bold text-gray-900 leading-tight mb-6">
            Book more qualified demos.
            <br />
            <span className="text-[#0069ff]">Close deals faster.</span>
          </h1>
        ...
        <div className="max-w-6xl mx-auto">
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-8">
            {[
              ...
              <div key={feature.title} className="p-6 rounded-xl border border-gray-200 hover:border-[#0069ff]/30 hover:shadow-sm transition-all">
                <div className="w-10 h-10 rounded-lg bg-blue-50 flex items-center justify-center mb-4">
                  <feature.icon className="w-5 h-5 text-[#0069ff]" />
                </div>
          ...
          <div className="space-y-12">
            {[
              ...
              <div key={item.step} className="flex gap-6 items-start">
                <div className="w-10 h-10 rounded-full bg-[#0069ff] flex items-center justify-center text-white font-bold text-lg flex-shrink-0">
                  {item.step}
                </div>
                <div>
            ...
            {[
              {
                ...
                features: ['1 event type', 'Unlimited bookings', 'Email notifications', 'Basic scheduling page'],
                cta: 'Get Started',
                highlighted: false,
              },
              {
              ...
              <div key={plan.name} className={`rounded-2xl p-8 ${plan.highlighted ? 'bg-[#0069ff] text-white ring-4 ring-[#0069ff]/20 scale-105' : 'bg-white border border-gray-200'}`}>
                ...
                <Link href="/signup" className={`block text-center py-2.5 rounded-lg font-medium text-sm transition-colors ${
                  plan.highlighted
                    ? 'bg-white text-[#0069ff] hover:bg-blue-50'
      ...
      {/* CTA */}
      <section className="py-20 px-4 bg-[#0069ff]">
        <div className="max-w-3xl mx-auto text-center">
          ...
          <Link href="/signup" className="inline-flex items-center gap-2 bg-white text-[#0069ff] px-8 py-3.5 rounded-lg font-medium text-lg hover:bg-blue-50 transition-colors">
