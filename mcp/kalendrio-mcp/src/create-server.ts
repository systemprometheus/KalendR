...
import { z } from 'zod';
import type { KalendrioConfig } from './lib/config.js';
...
export function createKalendrioMcpServer(config: KalendrioConfig) {
  ...
  server.registerResource(
    'kalendrio-event-type-guide',
    new ResourceTemplate('kalendrio://event-types/{username}/{slug}', { list: undefined }),
    {
